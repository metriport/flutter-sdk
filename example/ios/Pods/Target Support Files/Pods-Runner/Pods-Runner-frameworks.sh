...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/MetriportSDK/MetriportSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/integration_test/integration_test.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/metriport_flutter/metriport_flutter.framework"
